...
const uses={
 'broll-cutaway':'“先把要求说清楚”——在操作段前，用真实键盘镜头建立工作情境。',
 'broll-sequence':'“从不同例子里找共同办法”——三个角度依次出现，连接准备、操作和交流。',
 'broll-detail':'“咱们挑几条看看”——先落到实物，再把视线引向需要观察的区域。',
 'broll-brief-desk':'“谁来做、做什么、何时交、在哪填”——四张便签逐张落位。',
 'broll-message-pile':'“同事读完还是一头雾水”——问题接连出现，把沟通成本变得可见。',
 'broll-revision-stack':'“先别急着重做”——版本叠起来，圈出真正需要补充的内容。'
};
